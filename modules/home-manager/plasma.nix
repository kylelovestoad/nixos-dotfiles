{pkgs, inputs, ...}: (cfg: {
  ...
  config = {
    programs.plasma = {
      enable = true;
      shortcuts = {
        "ActivityManager"."switch-to-activity-f7bf83be-450b-40e0-bc44-fef4d5e14dcf" = [ ];
        ...
        "kitty.desktop"."_launch" = "Meta+Return,none,kitty";
      ...
      configFile = {
        ...
        "dolphinrc"."General"."ViewPropsTimestamp" = "2024,4,28,2,37,1.686";
        "dolphinrc"."IconsMode"."PreviewSize" = 80;
        "dolphinrc"."KFileDialog Settings"."Places Icons Auto-resize" = false;
        "dolphinrc"."KFileDialog Settings"."Places Icons Static Size" = 22;
        "dolphinrc"."Search"."Location" = "Everywhere";
        "kactivitymanagerdrc"."activities"."f7bf83be-450b-40e0-bc44-fef4d5e14dcf" = "Default";
        "kactivitymanagerdrc"."main"."currentActivity" = "f7bf83be-450b-40e0-bc44-fef4d5e14dcf";
        "kcminputrc"."Libinput/2362/14408/PIXA3848:00 093A:3848 Touchpad"."Enabled" = true;
        ...
        "kdeglobals"."KScreen"."ScreenScaleFactors" = "eDP-1=1.5;DP-1-0=1.5;DP-1-1=1.5;DP-1-2=1.5;DP-1-3=1.5;HDMI-1-0=1.5;DP-1-4=1.5;";
        ...
        "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{6847a8fe-1df0-4013-982f-2656ccc9ab3d}";
        ...
        "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{8bceb040-1de2-4543-a9e1-44998aa17d40}";
        ...
        "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{36e09749-8feb-45e9-83a7-7b747e971eaf}";
        ...
        "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{21aa896a-3830-460b-9f13-b2d3edb6f9b9}";
        ...
        "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{b0afba45-e68f-4d8d-a74f-d9b5c3064a46}";
        ...
        "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{904ed718-bdf4-4b0b-bb1b-6ec3092875f2}";
        ...
        "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{0390baa0-35e0-437a-bfca-b1d078cd5b01}";
        ...
        "kwinrc"."Desktops"."Id_1" = "ba456525-b566-4723-aa3d-995b86bcad4e";
        "kwinrc"."Desktops"."Id_2" = "b5aec026-3ba2-4514-b683-c37e50727d20";
        "kwinrc"."Desktops"."Id_3" = "dd1ea642-5835-4409-bd7c-3886c0803d6f";
        "kwinrc"."Desktops"."Id_4" = "a1da8076-c870-437a-a79c-ddc17c9b5b4a";
        ...
        "kwinrc"."Tiling/0576105f-e3ba-5538-b849-16164d46267b"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
        ...
        "kwinrc"."Tiling/604b0ccf-0418-5524-830d-38dfc0e32d4f"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
        "kwinrc"."Tiling/6204cb59-2e6d-5909-88e2-97701b9320a8"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
        "kwinrc"."Tiling/ad4dc0d9-8c4d-5572-b6d5-d340f6e291ab"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
        ...
        "plasmanotifyrc"."Applications/com.uploadedlobster.peek"."Seen" = true;
        "plasmanotifyrc"."Applications/discord"."Seen" = true;
        "plasmanotifyrc"."Applications/firefox"."Seen" = true;
        "plasmanotifyrc"."Applications/vesktop"."Seen" = true;
        "plasmarc"."Wallpapers"."usersWallpapers" = "/home/kyle/Downloads/firewatch.jpg";
      };
    };
  };
})